...
int 
CUSBaccess::OpenCleware(char *path) {
	int rval = cwOpenCleware(path);
...
CUSBaccess::Recover(int devNum) {
	int rval = cwRecover(NULL, devNum) ;

	return rval ;
	}

int
CUSBaccess::Recover(char *path, int devNum) {
	int rval = cwRecover(path, devNum) ;
